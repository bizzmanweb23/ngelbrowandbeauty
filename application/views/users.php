                    ...
                    <?php foreach($user as $users): ?>
                      <tr>
                        ...
                        <td><?= $users['role_name']?></td>
												<td><a href="<?= base_url('admin/userManagement/deleteAdminUser/'. $users['id'])?>" onclick="return confirm('Are you sure you want to delete this data?')" class="btn btn-default" data-toggle="tooltip" title="Delete" style="color:#61d3d4"><i class="fa fa-trash"></i></a></td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
