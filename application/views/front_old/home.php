        ...
        <div class="sepcialContainer">
          <div class="row">
            <div class="col-sm-6 col-xs-12 rightPadding">
              <div class="imagebox ">
                <img class="img-responsive lazyestload" data-src="<?= base_url(); ?>/assets/front/img/home/home-about.jpg" src="<?= base_url(); ?>/assets/front/img/home/home-about.jpg" alt="Image About">
              </div>
            </div>
            <div class="col-sm-6 col-xs-12">
              <div class="aboutInfo">
                <h2>About Ngelbrowandbeauty</h2>
    ...
    <div class="row">
      <div class="col-12">
        <div class="owl-carousel owl-theme">
            <div class="item"><div class="produtSingle">
                <div class="produtImage">
                  <img src="<?= base_url(); ?>/assets/front/img/products/product-1.jpg" data-src="<?= base_url(); ?>/assets/front/img/products/product-1.jpg" alt="Image Product" class="img-responsive">
                  <div class="productMask">
                    <ul class="list-inline productOption">
                      ...
                      <li>
                        <span class="morphing-btn-wrap"><a href="javascript:void(0)" data-morphing="" id="morphing" data-src="#morphing-content" class="morphing-btn">
                          <i class="fa fa-search" aria-hidden="true"></i>
                        </a></span><div class="morphing-btn-clone" style="display: none;"></div>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="item"><div class="produtSingle">
                <div class="produtImage">
                  <img src="<?= base_url(); ?>/assets/front/img/products/product-2.jpg" data-src="<?= base_url(); ?>/assets/front/img/products/product-2.jpg" alt="Image Product" class="img-responsive">
                  <div class="productMask">
                    <ul class="list-inline productOption">
                      <li class="favourite-icon">
                        <a class="icon" href="javascript:void(0)">
            ...
            <div class="item"><div class="produtSingle">
                <div class="produtImage">
                  <img src="<?= base_url(); ?>/assets/front/img/products/product-3.jpg" data-src="<?= base_url(); ?>/assets/front/img/products/product-3.jpg" alt="Image Product" class="img-responsive">
                  <div class="productMask">
                    <ul class="list-inline productOption">
                      <li class="favourite-icon">
                        <a class="icon" href="javascript:void(0)">
            ...
            <div class="item"><div class="produtSingle">
                <div class="produtImage">
                  <img src="<?= base_url(); ?>/assets/front/img/products/product-4.jpg" data-src="<?= base_url(); ?>/assets/front/img/products/product-4.jpg" alt="Image Product" class="img-responsive">
                  <div class="productMask">
                    <ul class="list-inline productOption">
                      <li class="favourite-icon">
                        <a class="icon" href="javascript:void(0)">
            ...
            <div class="item"><div class="produtSingle">
                <div class="produtImage">
                  <img src="<?= base_url(); ?>/assets/front/img/products/product-5.jpg" data-src="<?= base_url(); ?>/assets/front/img/products/product-5.jpg" alt="Image Product" class="img-responsive">
                  <div class="productMask">
                    <ul class="list-inline productOption">
                      <li class="favourite-icon">
                        <a class="icon" href="javascript:void(0)">
