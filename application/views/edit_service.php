          ...
          <div class="col-12">
			...
			<div class="row">
					...
					<div class="col-md-4"> 
					 ...
					 <div class="col-md-4"> 
						<div class="form-group ">
							...
							<div class="col-sm-12">
								<select class="form-control chosen chosen-select-deselect sub_child_category" name="sub_child_category" required>
									<option value="" hidden>Select Sub-Category</option>
									<?php foreach($subChildCategory as $subChildCategoryRow): ?>
									<option value="<?= $subChildCategoryRow['id']?>"<?php if($serviceData['sub_child_category'] == $subChildCategoryRow['id']){ echo "Selected";} ?>><?= $subChildCategoryRow['sub_child_category']?></option>
									<?php endforeach; ?> 
								</select>
							</div>
						</div> 
				...
				<div class="row">   
					<div class="col-md-4">      
						<div class="form-group">
							<label for="lowest_price" class="col-sm-6 control-label">lowest_price</label>
								<div class="col-sm-12">
									<input type="number" class="form-control" name="lowest_price" placeholder="Lowest Price Max Length : 30." value="<?= $serviceData['lowest_price'];?>">
								</div>
						</div>        
					</div>     
					<div class="col-md-4">        
						<div class="form-group ">
							...
							<div class="col-sm-12">
									<input type="number" class="form-control" name="service_price" id="service_price" placeholder="Service Price Max Length : 30." value="<?= $serviceData['service_price'];?>" required>
							</div>
						</div>      
					</div> 
					<div class="col-md-4">                       
							...
							<div class="form-group ">
								<label for="image" class="col-sm-6 control-label">Service Icon 
									...
									<div class="col-sm-12">
											...
											<input type="file" name="servicefiles" onchange="imgshow(this);" class="form-control">
									</div>
							</div>
						</div> 
						<div class="col-md-6">
