          ...
          <div class="col-12">
            ...
            <div class="card" style="border-radius: 15px">
              <div class="card-header">
				<div class="row">
					<div class="col-md-2">
						<a href="<?=base_url('admin/employeeManagement/add_employeeSalary')?>" target="_blank"><button type="button" class="btn btn-primary btn-custom">Add Salary </button></a>
					</div>
					<div class="col-md-2">
					...
					<div class="col-md-2">
						<a href="<?=base_url('admin/Pay_Structure/viewCPF')?>" target="_blank"><button type="button" class="btn btn-primary btn-custom">CPF </button></a>
					</div>
			  	</div>			
				<h4>Employee's Salary List</h4>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
