                ...
                <form id="add_package" action="<?= base_url('admin/procurementManagement/post_add_SendMail')?>" method="post" enctype="multipart/form-data">
					...
					<input type="hidden" class="form-control" name="supplier_id" value="<?= $SupplierData['id'] ?>">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group ">
									<label for="package_credits" class="col-sm-6 control-label">Details:<i class="required">*</i>
									</label>
									<div class="col-sm-12">
										<textarea name="ProductNameQuantity" rows="5" cols="80" class="" style="width: 100%;" placeholder="Enter Details."></textarea>
									</div>
								</div>  
							</div>
						</div>
						...
						<div class = "row">
							<div class="col-md-12">
								<h4 class="col-md-12 control-label">Select Products</h4>
								<?php foreach ($product_data as $product_dataRow) : ?>
									<div class="row">
										<div class="col-md-3"> 
											<input type="checkbox" id="productID" name="productID[]" value="<?= $product_dataRow['id'] ?>">  
											<input type="hidden" id="productname" name="productname[]" value="<?= $product_dataRow['name'] ?>">  
										...
										<div class="col-md-4">   
											<div class="form-group">
												...
												<div class="col-md-5">
													<input type="number" class="form-control" name="quantity[]" id="quantity_<?= $product_dataRow['id'] ?>" value="">
												</div>
											</div>
										</div>	
									</div>
