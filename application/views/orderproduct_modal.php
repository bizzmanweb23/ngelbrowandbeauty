...
?>
	<tr>
		...
		<td><a href="<?= base_url('admin/OrderManagement/viewOrderDetails/'.$order_product_id)?>" class="btn btn-default" data-toggle="tooltip" title="Edit" style="color:#61d3d4" target="_blank"><i class="fa fa-eye"></i></a>
