<div class="content-wrapper" style="margin-left: 270px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>offer & Packages Management</h1>
          </div>
        </div>
      </div><!-- /.container-fluid --> 
    </section>
                  ...
                  <tbody>
                    <?php foreach($productPackages as $packagesRow): ?>
                      <tr>
                        ...
                        <td><?= $packagesRow['status']?></td>
                        <td>
							<a href="<?= base_url('admin/employeeManagement/edit_employeeSalary/'.$packagesRow['id'])?>" class="btn btn-default" data-toggle="tooltip" title="Edit" style="color:#b8860b"><i class="fa fa-edit"></i></a>
							<a href="<?= base_url('admin/employeeManagement/deleteEmployeeSalary/'. $packagesRow['id'])?>" onclick="return confirm('Are you sure you want to delete this data?')" class="btn btn-default" data-toggle="tooltip" title="Delete" style="color:#b8860b"><i class="fa fa-trash"></i></a>
						</td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
