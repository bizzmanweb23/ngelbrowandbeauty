              ...
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="<?= base_url('admin/OrderManagement/viewOrderDetails/'.$cartProductRow['id'])?>" class="btn btn-default" data-toggle="tooltip" title="Edit" style="color:#61d3d4"><i class="fa fa-eye"></i></a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
