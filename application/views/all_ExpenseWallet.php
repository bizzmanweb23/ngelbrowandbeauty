             ...
             <?php /* <div class="card-header">
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered" id = "salary_table" style="overflow: auto; width: 100%; height: 250px; text-align: center;">
                  ...
                  <tbody>
                    <?php foreach($expenseWallet as $expenseWalletRow): ?>
                      <tr>
                        <td><?= $expenseWalletRow['first_name'] .' '.$expenseWalletRow['last_name']?></td>
						<td><?= $expenseWalletRow['referreduser_id'] ?></td>	
                        <td><?= $expenseWalletRow['balance']?></td>
                        <td><?= date("d-m-Y", strtotime($expenseWalletRow['created_at'])) ?></td>
